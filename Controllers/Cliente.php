...
class Cliente extends Controller
{
    ...
    public function listar(){
        ...
        for($i=0; $i<count($data);$i++){
            $data[$i]['acciones']= '
            <div class="btn-group">
            <button class="btn btn-primary mb-1 btn-sm" type="button" onclick="btnEditarUsuario('.$data[$i]['Id_cliente'].');"><i class="bi bi-pencil-square"></i></button>

            <button class="btn btn-danger mb-1 btn-sm" type="button" onclick="btnEliminarUsuario('.$data[$i]['Id_cliente'].');"><i class="bi bi-trash3-fill"></i></button>

            <button class="btn btn-success mb-1 btn-sm" type="button" onclick="btnActivarUsuario('.$data[$i]['Id_cliente'].');"><i class="bi bi-person-arms-up"></i></button>
             </div>';
        }
